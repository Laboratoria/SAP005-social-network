  ...
  profileBody.innerHTML = `
    <header class="profile-header">
      ...
      <div class="profile-user-info">
        <h2 class="profile-user-name">Samara Tokki</h2>
        <figure class="profile-favorite-quote">
          <blockquote class="profile-quote-text">
          ...
          <figcaption class="profile-quote-author">
            &mdash; Maya Angelou, <cite>palestra na Weber State University</cite>
          </figcaption>
        </figure>
      </div>
    </header>
