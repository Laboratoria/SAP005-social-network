...
A missão do projeto era de desenvolver uma rede social do zero, com o tema livre, onde trabalhamos em Squad e o objetivo principal de aprendizado é o [Single-page Application
